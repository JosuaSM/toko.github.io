  ...
  <body>
    ...
    <div class="humberger__menu__wrapper">
      ...
      <div class="humberger__menu__contact">
        <ul>
          <li><i class="fa fa-envelope"></i> josua@gmail.com</li>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              ...
              <ul>
                <li>Address: Jalan Sukasayur Bandung</li>
                <li>Phone: +62 815 7171 248</li>
                <li>Email: josua@gmail.com</li>
              </ul>
            </div>
          </div>
